...
| ------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------- |
| Remove Background (previous)    | ![](readme_assets/templates/remove_background_original_previous.png) | Previous output example saved before replacing transparent preview |
