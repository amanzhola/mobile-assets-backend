...
| `feature/catalog-api`              | Каталог инструментов и шаблонов | `/tools`, `/templates`, CatalogService    | [README](https://github.com/amanzholaimov/mobile-assets-backend/tree/feature/catalog-api)              |
