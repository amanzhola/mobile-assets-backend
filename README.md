...
| `template-prompt-mapping`          | Связь templateId и prompt       | prompt mapping                            | [README](https://github.com/amanzhola/mobile-assets-backend/tree/template-prompt-mapping/README.md)          |
