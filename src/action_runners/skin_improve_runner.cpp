...
SkinImproveRunner::SkinImproveRunner(
...
std::optional<std::string> SkinImproveRunner::FindNewestComfyOutputByPrefix(
...
std::optional<std::string> SkinImproveRunner::Run(
    ...
    try {
        const std::string server_action = "skin_improve";

        std::cout
            << "[SKIN_IMPROVE_RUNNER_START]\n"
            << "taskId=" << task_id << "\n"
